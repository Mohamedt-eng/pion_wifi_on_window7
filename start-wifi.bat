...
:1
echo  X      analyser wifi qlik sur___________(1)       X     
:2
echo  X      demarre wifi qlik sur____________(2)       X
:3
echo  X      afeche information de reseu______(3)       X          
:4
echo  X      stop information de reseu _______(4)       X   
:5
echo  X      stop wifi qlik sur ______________(5)       X
...
echo  X                                                 X
:6
echo  X      defragmente disk C: qlik sur-----(6)       X
:10     
echo  X      start traduction qlik sur--------(7)       X
:8
echo  X      start google qlik sur------------(8)       X
:9
echo  X      start youtube qlik sur-----------(9)       X
:7
echo  X      arrette ordinateur qlik sur-----(10)       X
:00
echo  X     netwayé afichage qlik sur________(00)       X
:11
echo  X     sortir session qlik sur__________(11)       X
echo  X                                                 X
echo  XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX
echo  XX
